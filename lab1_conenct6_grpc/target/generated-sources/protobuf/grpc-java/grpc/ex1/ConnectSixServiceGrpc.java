...
public final class ConnectSixServiceGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      grpc.ex1.GetTurnNumResponse> METHOD_GET_TURN_NUM =
      io.grpc.MethodDescriptor.<com.google.protobuf.Empty, grpc.ex1.GetTurnNumResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "grpc.ex1.ConnectSixService", "get_turn_num"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.google.protobuf.Empty.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              grpc.ex1.GetTurnNumResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class ConnectSixServiceImplBase implements io.grpc.BindableService {
    ...
    public void getTurnNum(com.google.protobuf.Empty request,
      ...
      asyncUnimplementedUnaryCall(METHOD_GET_TURN_NUM, responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.protobuf.Empty,
                grpc.ex1.GetTurnNumResponse>(
                  this, METHODID_GET_TURN_NUM)))
          .build();
    }
  }
  ...
  public static final class ConnectSixServiceStub extends io.grpc.stub.AbstractStub<ConnectSixServiceStub> {
    ...
    public void getTurnNum(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<grpc.ex1.GetTurnNumResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_TURN_NUM, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ConnectSixServiceBlockingStub extends io.grpc.stub.AbstractStub<ConnectSixServiceBlockingStub> {
    ...
    /**
     */
    public grpc.ex1.GetTurnNumResponse getTurnNum(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_TURN_NUM, getCallOptions(), request);
    }
  }
  ...
  public static final class ConnectSixServiceFutureStub extends io.grpc.stub.AbstractStub<ConnectSixServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.ex1.GetTurnNumResponse> getTurnNum(
        com.google.protobuf.Empty request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_TURN_NUM, getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_GET_TURN_NUM = 4;
      ...
      switch (methodId) {
        ...
        case METHODID_GET_TURN:
          serviceImpl.getTurn((com.google.protobuf.Empty) request,
              (io.grpc.stub.StreamObserver<grpc.ex1.GetTurnResponse>) responseObserver);
          break;
        case METHODID_GET_TURN_NUM:
          serviceImpl.getTurnNum((com.google.protobuf.Empty) request,
              (io.grpc.stub.StreamObserver<grpc.ex1.GetTurnNumResponse>) responseObserver);
          break;
        default:
